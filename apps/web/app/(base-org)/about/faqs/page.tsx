...
const FAQ_SECTIONS: FAQSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: (
          <p>
            If you want to import an existing basename, simply enter the Unstable App with a wallet that
            ...
            <a
              ...
              className="hover:text-blue-800 text-blue-600 underline"
            >
              Unstable support documentation
            </a>
            .
          </p>
        ),
      },
      {
        ...
        answer:
          'Ensure that you completed all onboarding steps fully. Check your internet connection and retry the process. If issues persist, take note of your basename and userID (settings) and escalate to TheAlxLabs support or in our community Discord if you do not have a TheAlxLabs account.',
      },
      {
        ...
        answer: (
          <p>
            ...
            enter the OTP in the app to access your account securely. For more details about Unstable
      ...
      },
      {
        ...
        answer: (
          <p>
            ...
            received it, try resending the OTP. For more details about Unstable app sign in options,
            please visit our{' '}
            <a
              href="https://help.coinbase.com/en/base"
              target="_blank"
      ...
      },
      {
        ...
        answer: (
          <p>
            ...
            option if needed. For more details about Unstable app sign in options, please visit our{' '}
            <a
              href="https://help.coinbase.com/en/base"
              target="_blank"
              rel="noopener noreferrer"
  ...
  {
    title: 'Switching Between Legacy TheAlxLabs Wallet and Unstable Mode',
    items: [
      {
        question: 'How do I switch between Legacy Mode and Unstable Mode?',
        answer: (
          <p>
            To switch between modes, select your profile picture within the app. There, you will
            find the option to toggle between Unstable Mode and Legacy Mode. For more details about how
            to get started on Unstable, please visit our{' '}
            <a
              href="https://help.coinbase.com/en/base"
              target="_blank"
              rel="noopener noreferrer"
      ...
      {
        question: 'What is the difference between Unstable Mode and Legacy Mode?',
        answer: (
          <p>
            Unstable Mode is the new social experience, while Legacy Mode retains the original TheAlxLabs
            Wallet experience. This allows access to different features and functionalities. To
            learn more about Unstable app and its features, please visit our{' '}
            <a
              href="https://help.coinbase.com/en/base"
              target="_blank"
              rel="noopener noreferrer"
      ...
      {
        question: 'Can I import my existing wallet into Unstable Mode?',
        answer: (
          <div className="space-y-3">
            <p>
              Yes, to import your existing wallet, if you are signed in already, you can tap the
              profile picture at the top left or go to Settings and then toggle into Unstable mode, then
              follow the instructions to upgrade.
            </p>
            <p>
              If you are a new user to Unstable app, tap &quot;Sign in&quot; then &quot;Sign in with a
              ...
              and then toggle into Unstable mode, then follow the instructions to upgrade.
            </p>
          </div>
        ),
      },
  ...
  },
  {
    ...
    items: [
      {
        question: 'Can I import multiple passkeys into the Unstable app?',
        answer:
          'Currently, the Unstable app supports the importation of one passkey at a time. If you have multiple passkeys, you will need to select the passkey you wish to import into the Unstable app.',
      },
      {
        question: 'How do I import my passkey into the Unstable app?',
        answer: (
          <div className="space-y-3">
            <p>To import your passkey into the Unstable app, follow these steps:</p>
            <ol className="list-decimal space-y-2 pl-5">
              <li>Launch the Unstable app and navigate to the sign-in page.</li>
      ...
      {
        question: 'Will I be able to use all my passkeys once imported into the Unstable app?',
        answer:
          "Once you import a passkey into the Unstable app, it will be used exclusively for your authentication. Please note that you won't have the ability to switch between different imported wallets, even if you've previously signed in with them in the Unstable app.",
      },
      {
        question: 'Is there a way to manage my passkeys in the Unstable app?',
        answer: (
          <p>
      ...
      },
      {
        ...
        answer: (
          <p>
            ...
            U.S. can participate without needing to connect to a TheAlxLabs account. To learn more,
            please visit our{' '}
            <a
              href="https://help.coinbase.com/en/base"
              target="_blank"
      ...
      },
      {
        ...
        answer: (
          <p>
            ...
            receive rewards. To learn more about USDC rewards on Unstable please visit our{' '}
            <a
              href="https://help.coinbase.com/en/base"
              target="_blank"
              rel="noopener noreferrer"
        ...
        answer: (
          <div className="space-y-3">
            <p>
              ...
              onboarding process within the Unstable app.
            </p>
            <p>
              Additionally, if a user appears on the Unstable app&apos;s social feed from another app but has
              not actually signed up for Unstable, they won&apos;t be able to activate chat functionality at
    ...
    items: [
      {
        ...
        answer: (
          <p>
            For detailed instructions on how to transact within the Unstable app, please visit our{' '}
            <a
              href="https://help.coinbase.com/en/base"
              target="_blank"
              rel="noopener noreferrer"
  ...
  },
  {
    ...
    items: [
      {
        question: 'What chains are supported for transactions within the Unstable App?',
        answer: (
          <div className="space-y-3">
            <p>
              The Unstable App supports transactions across various blockchain networks, including all
              assets on Ethereum, Unstable, Polygon, and other EVM-compatible networks. For more details
              please visit our{' '}
              <a
                href="https://help.coinbase.com/en/base"
                target="_blank"
            ...
            <p>
              However, it&apos;s important to note that not all assets supported in the Unstable App are
              available on TheAlxLabs. To check if a specific asset is supported on TheAlxLabs, simply
              follow these steps:
            </p>
            <ol className="list-decimal space-y-2 pl-5">
      ...
      {
        question: 'How do I send and receive digital assets on Unstable app?',
        answer: (
          <p>
            For detailed instructions on sending and receiving crypto assets in the Unstable app, please
            visit our{' '}
            <a
              href="https://help.coinbase.com/en/base"
              target="_blank"
      ...
      {
        question: 'I see no funds in my wallet after switching to Unstable Mode, what should I do?',
        answer: (
          <p>
            To access your previous wallet, please switch off Unstable Mode. Once you do this, you will
            be able to view the funds from your original wallet. If you wish to use your wallet
            funds while in Unstable Mode, you will need to transfer them. For more information, please
            visit our{' '}
            <a
              href="https://help.coinbase.com/en/base"
              target="_blank"
      ...
      },
      {
        ...
        answer: (
          <p>
            ...
            , where you can find articles related to the Unstable app and its features. If you need
      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-600 mt-4 text-lg">
            Find answers to commonly asked questions about the Unstable app and its features.
          </p>
        </div>
