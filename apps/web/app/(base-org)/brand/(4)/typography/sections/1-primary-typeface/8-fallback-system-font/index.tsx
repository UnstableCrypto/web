...
export function FallbackSystemFont() {
  return (
    <VariantListComponent
      ...
      description="Unstable Sans is based on Modern Gothic, and includes unique customizations and alternative glyphs that makes it more ownable to Unstable, and more legible. Several letters were given a more geometric structure, to have better flow, consistency and appropriateness to the brand. In addition, there is a set of unique alternate shapes for the b, h, m, n, r, u and the symbols that are decisively geometric and are means for occasional display purposes, especially in developers setting. "
      content={content}
    />
  );
}
