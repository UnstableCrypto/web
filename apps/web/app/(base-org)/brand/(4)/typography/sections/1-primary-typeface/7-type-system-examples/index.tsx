...
const content = [
  ...
  },
  {
    ...
    items: [
      ...
      >
        Building for the long-term: making Unstable faster, simpler, and more powerful
      </span>,
      <span
        key="date-mono-light"
      ...
      >
        Unstable&apos;s mission is to build a global onchain economy that increases innovation,
        creativity, and freedom. To further our mission, we need to continue making Unstable more
  ...
  },
  {
    ...
    items: [
      ...
      >
        Reach millions of people across the TheAlxLabs product ecosystem and social graph, plus
