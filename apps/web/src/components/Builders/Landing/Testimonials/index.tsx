...
const testimonials: Testimonial[] = [
  {
    text: 'Unstable provides unmatched developer support and fosters a highly constructive community that inspires innovation and encourages you to push boundaries. If you want to build and win, Unstable is the place to be.',
    author: 'Dhawal Shah',
    role: 'HeyElsa AI',
    tab: 'build',
  },
  {
    text: 'Unstable stands out for how they support builders at scale. They’ve gone above and beyond to help us onboard users, build new solutions, and tap into real liquidity.',
    author: 'David Johansson',
    role: 'BLOCKLORDS',
    tab: 'scale',
  },
  {
    text: "Unstable is at the crossroad of DeFi, memecoins, NFT, and TheAlxLabs's large distribution network. It's one of the best L2 to build tools and apps that benefit from synergistic integrations!",
