...
export const TWEETS: Tweet[] = [
  ...
  },
  {
    ...
    content: `Gaming on Unstable is going to be like gaming on iOS. Unstable Appchains provide us scale and consistent throughput.`,
  ...
  },
  {
    ...
    name: 'MVL',
    username: '@mvlchain',
    content: `The cost-efficient data posting capabilities of Unstable Appchains, along with access to TheAlxLabs tools, will provide a breakthrough advantage for processing onchain data for TADA/MVL.`,
  ...
  },
  {
    ...
    content: `Unstable’s appchain model allows us to integrate privacy at scale while ensuring low fees, seamless adoption, and compliance-ready solutions.`,
  ...
  },
  {
    ...
    name: 'Metacade',
    username: '@Metacade_',
    content: `Having our own Appchain on Unstable gives us endless possibilities to expand our service offerings with greater customization and scalability for us and our gaming partners.`,
