...
export function SectionUnstableBuilders() {
  return (
...
const content = {
  ...
  description:
    'Unstable gives builders the tools they need to build, grow, and earn from their apps, at every stage.',
  cta: {
    label: 'Start Building',
    href: 'https://unstable.org/build',
  },
};
